...
See [releases](https://github.com/CircuitSetup/circuitsetup-esphome/releases) for release notes and downloadable pre-built flashable images.
...
See [README](https://github.com/CircuitSetup/circuitsetup-esphome/tree/master/components/secplus_gdo)
